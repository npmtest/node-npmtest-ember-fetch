...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-ember-fetch/node_modules/ember-fetch/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-ember-fetch">npmtest-ember-fetch (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-ember-fetch/node_modules/ember-fetch/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-ember-fetch/node_modules/ember-fetch/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >    app.import('vendor/ember-fetch.js', {</span>
      exports: {
        default: [
          'default',
          'Headers',
...
<span class="cstat-no" title="statement not covered" >    if (isFastBoot()) {</span>
<span class="cstat-no" title="statement not covered" >      return treeForNodeFetch();</span>
    } else {
<span class="cstat-no" title="statement not covered" >      return treeForBrowserFetch();</span>
    }
  }
};
&nbsp;
...
<span class="fstat-no" title="function not covered" >function isFastBoot() {</span>
<span class="cstat-no" title="statement not covered" >  return process.env.EMBER_CLI_FASTBOOT === 'true';</span>
}
&nbsp;
...
<span class="fstat-no" title="function not covered" >function treeForNodeFetch() {</span>
<span class="cstat-no" title="statement not covered" >  return normalizeFileName(funnel(path.join(__dirname, './assets'), {</span>
...
// app.
<span class="fstat-no" title="function not covered" >function treeForBrowserFetch() {</span>
<span class="cstat-no" title="statement not covered" >  var fetchPath = require.resolve('whatwg-fetch');</span>
<span class="cstat-no" title="statement not covered" >  var expandedFetchPath = expand(fetchPath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  var fetch = normalizeFileName(find(expandedFetchPath));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new Template(fetch, templatePath, <span class="fstat-no" title="function not covered" >function(content) {</span></span>
...
<span class="fstat-no" title="function not covered" >function normalizeFileName(tree) {</span>
<span class="cstat-no" title="statement not covered" >  return rename(tree, <span class="fstat-no" title="function not covered" >function() {</span></span>
<span class="cstat-no" title="statement not covered" >    return 'ember-fetch.js';</span>
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function expand(input) {</span>
<span class="cstat-no" title="statement not covered" >  var dirname = path.dirname(input);</span>
<span class="cstat-no" title="statement not covered" >  var file = path.basename(input);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return dirname + '/{' + file + '}';</span>
}
&nbsp;
&nbsp;</pre></td></tr>
</table></pre>
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Fri Apr 21 2017 13:24:23 GMT+0000 (UTC)</div>
</div>
</body>
</html>
